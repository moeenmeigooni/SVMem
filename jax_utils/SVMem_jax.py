...
#                 b = b.at[k].set(j)
#                 k += 1
            (a, b, k) = jax.lax.cond(pred=(i < j), 
                                     true_fun=lambda a, b, k, i, j: (a.at[k].set(i), b.at[k].set(j), k+1), 
                                     false_fun=lambda a, b, k, i, j: (a, b, k), 
                                     operand=*(a, b, k, i, j) ) #.item() for scalar;; necessary for differrentiation!
    return a, b
